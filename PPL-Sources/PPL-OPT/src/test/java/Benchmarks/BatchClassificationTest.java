...
public class BatchClassificationTest {
    ...
    public void init() {
        ...
        String modelname = "batch_classification";
...
*/
    ...
    public void test() {
        ...
        int splitSize = 4 * 65536;
        DataSplitTable.create(apt, splitSize);
        FlatAPT flatAPT = FlatAPTGenerator.generate(apt, splitSize, splitSize);
        APTInlineHandler inlineHandler = new APTInlineHandler(apt);
