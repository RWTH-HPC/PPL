...
import de.parallelpatterndsl.patterndsl.coco.IncrementOnlyAssignmentVariableCoCo;
import de.parallelpatterndsl.patterndsl.coco.ListsMustBeInitializedCoCo;
...
public class ListMustBeInitializedCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        ListsMustBeInitializedCoCo CoCo = new ListsMustBeInitializedCoCo();
    ...
    @CsvSource({
            "ListMustBeInitialized",
            "ListMustBeInitialized2",
            "ListMustBeInitialized3"
    })
