...
import de.parallelpatterndsl.patterndsl.coco.DynamicProgrammingSyntaxCoCo;
...
public class DynamicProgrammingSyntaxCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        DynamicProgrammingSyntaxCoCo CoCo = new DynamicProgrammingSyntaxCoCo();
