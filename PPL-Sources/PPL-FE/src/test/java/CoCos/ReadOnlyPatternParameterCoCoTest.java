...
import de.parallelpatterndsl.patterndsl.coco.ReadOnlyPatternParameterCoCo;
...
public class ReadOnlyPatternParameterCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        ReadOnlyPatternParameterCoCo CoCo = new ReadOnlyPatternParameterCoCo();
