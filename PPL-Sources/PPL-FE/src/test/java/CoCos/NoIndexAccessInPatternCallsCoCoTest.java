...
import de.parallelpatterndsl.patterndsl.coco.NoCopyInFrontendCoCo;
...
public class NoIndexAccessInPatternCallsCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        NoIndexAccessInPatternCallsCoCo CoCo = new NoIndexAccessInPatternCallsCoCo();
