...
import de.parallelpatterndsl.patterndsl.coco.ListExpressionsOnlyForInitializationCoCo;
...
public class ListExpressionOnlyForInitializationCoCoTest extends AbstractCocoTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "ListExpressionsOnlyForInitialization"
    })
    public void testValid(String modelStringPath){
        ...
        ListExpressionsOnlyForInitializationCoCo CoCo = new ListExpressionsOnlyForInitializationCoCo();
