...
import de.parallelpatterndsl.patterndsl.coco.DimensionToSmallCoCo;
...
public class DimensionToSmallCoCoTest extends AbstractCocoTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "DimensionToSmallCoCo",
            "DimensionToSmallCoCo2"
    })
    public void testValid(String modelStringPath){
        ...
        DimensionToSmallCoCo CoCo = new DimensionToSmallCoCo();
