...
import de.parallelpatterndsl.patterndsl.coco.NoIndexAccessInIndexAccessCoCo;
import de.parallelpatterndsl.patterndsl.coco.NoIndexAccessInPatternCallsCoCo;
...
public class NoIndexAccessInIndexAccessCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        NoIndexAccessInIndexAccessCoCo CoCo = new NoIndexAccessInIndexAccessCoCo();
