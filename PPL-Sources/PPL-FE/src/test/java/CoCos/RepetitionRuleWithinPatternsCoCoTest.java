...
import de.parallelpatterndsl.patterndsl.coco.RepetitionRuleWithinPatternsCoCo;
...
public class RepetitionRuleWithinPatternsCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        RepetitionRuleWithinPatternsCoCo CoCo = new RepetitionRuleWithinPatternsCoCo();
