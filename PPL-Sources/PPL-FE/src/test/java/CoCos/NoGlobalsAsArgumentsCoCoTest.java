...
import de.parallelpatterndsl.patterndsl.coco.NoGlobalsAsArgumentCoCo;
import de.parallelpatterndsl.patterndsl.coco.NoINDEXAsVariableCoCo;
...
public class NoGlobalsAsArgumentsCoCoTest extends AbstractCocoTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "NoGlobalsAsArguments",
            "NoGlobalsAsArguments2"
    })
    public void testValid(String modelStringPath){
        ...
        NoGlobalsAsArgumentCoCo CoCo = new NoGlobalsAsArgumentCoCo();
