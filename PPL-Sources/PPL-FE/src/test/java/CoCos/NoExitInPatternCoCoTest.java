...
import de.parallelpatterndsl.patterndsl.coco.NoExitInPatternCoCo;
...
public class NoExitInPatternCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        NoExitInPatternCoCo CoCo = new NoExitInPatternCoCo();
