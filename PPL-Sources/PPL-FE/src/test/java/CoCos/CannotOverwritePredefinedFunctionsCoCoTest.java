...
import de.parallelpatterndsl.patterndsl.coco.CannotOverwritePredefinedFunctionsCoCo;
import de.parallelpatterndsl.patterndsl.coco.PatternReturnVariableExistsCoCo;
...
public class CannotOverwritePredefinedFunctionsCoCoTest extends AbstractCocoTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "CannotOverwritePredefinedFunctions"
    })
    public void testValid(String modelStringPath){
        ...
        CannotOverwritePredefinedFunctionsCoCo CoCo = new CannotOverwritePredefinedFunctionsCoCo();
