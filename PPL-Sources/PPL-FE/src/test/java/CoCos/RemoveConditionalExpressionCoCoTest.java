...
import de.parallelpatterndsl.patterndsl.coco.RemoveConditionalExpressionCoCo;
...
public class RemoveConditionalExpressionCoCoTest extends AbstractCocoTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "RemoveConditionalExpressionCoCo"
    })
    public void testValid(String modelStringPath){
        ...
        RemoveConditionalExpressionCoCo CoCo = new RemoveConditionalExpressionCoCo();
