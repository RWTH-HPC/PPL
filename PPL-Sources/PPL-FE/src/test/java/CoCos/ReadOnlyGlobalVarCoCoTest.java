...
import de.parallelpatterndsl.patterndsl.coco.ReadOnlyGlobalVarsCoCo;
...
public class ReadOnlyGlobalVarCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        ReadOnlyGlobalVarsCoCo CoCo = new ReadOnlyGlobalVarsCoCo();
