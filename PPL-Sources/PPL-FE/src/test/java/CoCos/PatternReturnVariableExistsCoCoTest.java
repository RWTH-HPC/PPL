...
public class PatternReturnVariableExistsCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        PatternReturnVariableExistsCoCo CoCo = new PatternReturnVariableExistsCoCo();
