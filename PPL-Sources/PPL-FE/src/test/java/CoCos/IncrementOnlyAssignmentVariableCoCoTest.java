...
import de.parallelpatterndsl.patterndsl.coco.IncrementOnlyAssignmentCoCo;
...
public class IncrementOnlyAssignmentVariableCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        IncrementOnlyAssignmentVariableCoCo CoCo = new IncrementOnlyAssignmentVariableCoCo();
