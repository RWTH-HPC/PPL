...
import de.parallelpatterndsl.patterndsl.coco.ReturnWithoutStackVarCoCo;
...
public class ReturnWithoutStackVarCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        ReturnWithoutStackVarCoCo CoCo = new ReturnWithoutStackVarCoCo();
