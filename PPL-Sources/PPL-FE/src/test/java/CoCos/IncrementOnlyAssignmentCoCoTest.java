...
public class IncrementOnlyAssignmentCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        IncrementOnlyAssignmentCoCo CoCo = new IncrementOnlyAssignmentCoCo();
