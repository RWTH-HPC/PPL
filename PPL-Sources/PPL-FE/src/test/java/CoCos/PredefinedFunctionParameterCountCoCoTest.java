...
import de.parallelpatterndsl.patterndsl.coco.ConstantsWithoutCallExpressionCoCo;
import de.parallelpatterndsl.patterndsl.coco.PredefinedFunctionParameterCountCoCo;
...
public class PredefinedFunctionParameterCountCoCoTest extends AbstractCocoTest {
    ...
    @ParameterizedTest
    @CsvSource({
            "PredefinedFunctionParameterCount",
            "PredefinedFunctionParameterCount2"
    })
    public void testValid(String modelStringPath){
        ...
        PredefinedFunctionParameterCountCoCo CoCo = new PredefinedFunctionParameterCountCoCo();
