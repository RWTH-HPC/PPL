...
import de.parallelpatterndsl.patterndsl.coco.NoForEachLoopAssignmentCoCo;
...
public class NoForEachLoopAssignmentCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        NoForEachLoopAssignmentCoCo CoCo = new NoForEachLoopAssignmentCoCo();
