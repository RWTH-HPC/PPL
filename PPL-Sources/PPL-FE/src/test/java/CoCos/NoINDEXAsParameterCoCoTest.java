...
import de.parallelpatterndsl.patterndsl.coco.NoINDEXAsParameterCoCo;
...
public class NoINDEXAsParameterCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        NoINDEXAsParameterCoCo CoCo = new NoINDEXAsParameterCoCo();
