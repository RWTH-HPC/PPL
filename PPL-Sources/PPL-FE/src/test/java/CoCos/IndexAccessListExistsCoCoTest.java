...
public class IndexAccessListExistsCoCoTest extends AbstractCocoTest {
    ...
    public void testValid(String modelStringPath){
        ...
        IndexAccessListExistsCoCo CoCo = new IndexAccessListExistsCoCo();
