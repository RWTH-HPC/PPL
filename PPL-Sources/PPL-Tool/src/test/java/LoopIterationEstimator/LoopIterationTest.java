...
public class LoopIterationTest {
    ...
    public static final String MODEL_SOURCE_PATH = "./src/test/resources/LoopIterationEstimator/";
...
*/
        ...
        /**
         * Test the loop iteration counter.
         */
        FLOPTest helper = new FLOPTest();
        helper.estimate(abstractPatternTree.getRoot());
