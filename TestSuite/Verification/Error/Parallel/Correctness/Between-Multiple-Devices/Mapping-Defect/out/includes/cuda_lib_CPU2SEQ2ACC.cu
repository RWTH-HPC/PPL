...
#include <stdio.h>
#include <stdlib.h>
#include "cuda_lib_CPU2SEQ2ACC.hxx"
#include "cuda_lib_CPU2SEQ2ACC.cuh"
#include <iostream>
#include <cuda.h>
...
void cuda_wrapper_increment_88tU14gDpz(int32_t* intermediate_PCMJVl88HJ, int32_t* result_lavXINJeC1 ) {

	kernel_cuda_wrapper_increment_88tU14gDpz<<<1, 168>>> (intermediate_PCMJVl88HJ, result_lavXINJeC1 );
}
...
void kernel_cuda_wrapper_increment_88tU14gDpz(int32_t*  intermediate_PCMJVl88HJ, int32_t* result_lavXINJeC1 ) {
	...
	for ( int range_iterator = 0; range_iterator < exec_range + 0; range_iterator++) {
		int INDEX_88tU14gDpz = tid * exec_range + range_iterator + 32;
		if (tid < 32) {
			INDEX_88tU14gDpz -= 32;
		}
		result_lavXINJeC1[(INDEX_88tU14gDpz)] = intermediate_PCMJVl88HJ[(INDEX_88tU14gDpz)] + 1;
	}
}
