...
#include <stdio.h>
#include <stdlib.h>
#include "cuda_lib_FlowACC2CPU.hxx"
#include "cuda_lib_FlowACC2CPU.cuh"
#include <iostream>
#include <cuda.h>
...
void cuda_wrapper_increment_dFN25kCeJ7(int32_t* initial_p2nXoGUtlC, int32_t* intermediate_j8keT4oZLx ) {

	kernel_cuda_wrapper_increment_dFN25kCeJ7<<<1, 168>>> (initial_p2nXoGUtlC, intermediate_j8keT4oZLx );
}
...
void kernel_cuda_wrapper_increment_dFN25kCeJ7(int32_t*  initial_p2nXoGUtlC, int32_t* intermediate_j8keT4oZLx ) {
	...
	for ( int range_iterator = 0; range_iterator < exec_range + 0; range_iterator++) {
		int INDEX_dFN25kCeJ7 = tid * exec_range + range_iterator + 32;
		if (tid < 32) {
			INDEX_dFN25kCeJ7 -= 32;
		}
		intermediate_j8keT4oZLx[(INDEX_dFN25kCeJ7)] = initial_p2nXoGUtlC[(INDEX_dFN25kCeJ7)] + 1;
	}
}
