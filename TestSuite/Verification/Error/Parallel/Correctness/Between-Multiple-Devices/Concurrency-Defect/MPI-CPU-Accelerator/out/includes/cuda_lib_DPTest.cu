...
void cuda_wrapper_incr_tGTQDtaA7M(int32_t* initial_nUIfy29ORQ, int32_t* result_8jvxK8OViz, int INDEX0_t2MUMiZdzW) {

	kernel_cuda_wrapper_incr_tGTQDtaA7M<<<1, 168>>> (initial_nUIfy29ORQ, result_8jvxK8OViz, INDEX0_t2MUMiZdzW);
}
...
void kernel_cuda_wrapper_incr_tGTQDtaA7M(int32_t* initial_nUIfy29ORQ, int32_t* result_8jvxK8OViz, int INDEX0_t2MUMiZdzW) {
	...
	for ( int range_iterator = 0; range_iterator < exec_range + 0; range_iterator++) {
		int INDEX1_t2MUMiZdzW = tid * exec_range + range_iterator + 50;
		if (tid < 50) {
			INDEX1_t2MUMiZdzW -= 50;
		}
		result_8jvxK8OViz[(INDEX1_t2MUMiZdzW)] = initial_nUIfy29ORQ[(INDEX1_t2MUMiZdzW)] + 1;
	}
}

void cuda_wrapper_incr_pfxq6fvbpp(int32_t* initial_nUIfy29ORQ, int32_t* result_8jvxK8OViz, int INDEX0_t2MUMiZdzW) {

	kernel_cuda_wrapper_incr_pfxq6fvbpp<<<1, 168>>> (initial_nUIfy29ORQ, result_8jvxK8OViz, INDEX0_t2MUMiZdzW);
}
