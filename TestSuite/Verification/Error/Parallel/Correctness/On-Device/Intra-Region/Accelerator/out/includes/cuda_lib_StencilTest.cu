...
void cuda_wrapper_sum_SqbO3lxnl4(int32_t* initial_AE8KeHIIpH, int32_t* result_fPrqt0iey2 ) {

	kernel_cuda_wrapper_sum_SqbO3lxnl4<<<1, 168>>> (initial_AE8KeHIIpH, result_fPrqt0iey2 );
}
...
void kernel_cuda_wrapper_sum_SqbO3lxnl4(int32_t* initial_AE8KeHIIpH, int32_t* result_fPrqt0iey2 ) {
	...
	for ( size_t range_iterator = 1; range_iterator < exec_range + 1; range_iterator++) {
		int INDEX0_SqbO3lxnl4 = tid * exec_range + range_iterator + 30;
		if (tid < 30) {
			INDEX0_SqbO3lxnl4 -= 30;
		}
		for (size_t INDEX1_SqbO3lxnl4 = 1; INDEX1_SqbO3lxnl4 < 1 + 98; ++INDEX1_SqbO3lxnl4) {
			for (size_t INDEX2_SqbO3lxnl4 = 1; INDEX2_SqbO3lxnl4 < 1 + 98; ++INDEX2_SqbO3lxnl4) {
				result_fPrqt0iey2[100LL * 100LL * (INDEX0_SqbO3lxnl4) + 100LL * (INDEX1_SqbO3lxnl4) + (INDEX2_SqbO3lxnl4)] = initial_AE8KeHIIpH[100LL * 100LL * (INDEX0_SqbO3lxnl4 + 1) + 100LL * (INDEX1_SqbO3lxnl4) + (INDEX2_SqbO3lxnl4)] + initial_AE8KeHIIpH[100LL * 100LL * (INDEX0_SqbO3lxnl4) + 100LL * (INDEX1_SqbO3lxnl4 + 1) + (INDEX2_SqbO3lxnl4)] + initial_AE8KeHIIpH[100LL * 100LL * (INDEX0_SqbO3lxnl4) + 100LL * (INDEX1_SqbO3lxnl4) + (INDEX2_SqbO3lxnl4 + 1)] + initial_AE8KeHIIpH[100LL * 100LL * (INDEX0_SqbO3lxnl4 - 1) + 100LL * (INDEX1_SqbO3lxnl4) + (INDEX2_SqbO3lxnl4)] + initial_AE8KeHIIpH[100LL * 100LL * (INDEX0_SqbO3lxnl4) + 100LL * (INDEX1_SqbO3lxnl4 - 1) + (INDEX2_SqbO3lxnl4)] + initial_AE8KeHIIpH[100LL * 100LL * (INDEX0_SqbO3lxnl4) + 100LL * (INDEX1_SqbO3lxnl4) + (INDEX2_SqbO3lxnl4 - 1)] + initial_AE8KeHIIpH[100LL * 100LL * (INDEX0_SqbO3lxnl4) + 100LL * (INDEX1_SqbO3lxnl4) + (INDEX2_SqbO3lxnl4)];
			}
		}
	}
}
