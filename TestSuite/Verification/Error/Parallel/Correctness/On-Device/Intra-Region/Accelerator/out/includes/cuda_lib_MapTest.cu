...
void cuda_wrapper_increment_Nsskf7AveP(int32_t* initial_fYXpDZdEol, int32_t* result_qB8gMN6lDm ) {

	kernel_cuda_wrapper_increment_Nsskf7AveP<<<1, 168>>> (initial_fYXpDZdEol, result_qB8gMN6lDm );
}
...
void kernel_cuda_wrapper_increment_Nsskf7AveP(int32_t*  initial_fYXpDZdEol, int32_t* result_qB8gMN6lDm ) {
	...
	for ( int range_iterator = 0; range_iterator < exec_range + 0; range_iterator++) {
		int INDEX_Nsskf7AveP = tid * exec_range + range_iterator + 32;
		if (tid < 32) {
			INDEX_Nsskf7AveP -= 32;
		}
		result_qB8gMN6lDm[(INDEX_Nsskf7AveP)] = initial_fYXpDZdEol[(INDEX_Nsskf7AveP)] + 1;
	}
}
