...
#ifndef CUDA_LIB_RecursionNestedTest_HXX
#define CUDA_LIB_RecursionNestedTest_HXX
...
void cuda_wrapper_increment_5S36YZbPJO(int32_t* initial_EbYenl3BrQ, int32_t* result_gJ1dDQWGX2 );
