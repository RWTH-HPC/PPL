...
#include <stdio.h>
#include <stdlib.h>
#include "cuda_lib_StencilNestedTest.hxx"
#include "cuda_lib_StencilNestedTest.cuh"
#include <iostream>
#include <cuda.h>
...
void cuda_wrapper_partialStencil_pLNuzDlBWy(int32_t* initial_PiJdo0ggGx, int32_t* result_qN04jyEyY1 ) {

	kernel_cuda_wrapper_partialStencil_pLNuzDlBWy<<<1, 168>>> (initial_PiJdo0ggGx, result_qN04jyEyY1 );
}
...
void kernel_cuda_wrapper_partialStencil_pLNuzDlBWy(int32_t*  initial_PiJdo0ggGx, int32_t* result_qN04jyEyY1 ) {
	...
	for ( int range_iterator = 0; range_iterator < exec_range + 0; range_iterator++) {
		int INDEX_pLNuzDlBWy = tid * exec_range + range_iterator + 32;
		if (tid < 32) {
			INDEX_pLNuzDlBWy -= 32;
		}
		for (size_t INDEX0_CSgvaH5VL6 = 1; INDEX0_CSgvaH5VL6 < 1 + 98; ++INDEX0_CSgvaH5VL6) {
			for (size_t INDEX1_CSgvaH5VL6 = 1; INDEX1_CSgvaH5VL6 < 1 + 98; ++INDEX1_CSgvaH5VL6) {
				result_qN04jyEyY1[100LL * 100LL * (INDEX_pLNuzDlBWy) + 100LL * (INDEX0_CSgvaH5VL6) + (INDEX1_CSgvaH5VL6)] = initial_PiJdo0ggGx[100LL * 100LL * (INDEX_pLNuzDlBWy) + 100LL * (INDEX0_CSgvaH5VL6 + 1) + (INDEX1_CSgvaH5VL6)] + initial_PiJdo0ggGx[100LL * 100LL * (INDEX_pLNuzDlBWy) + 100LL * (INDEX0_CSgvaH5VL6) + (INDEX1_CSgvaH5VL6 + 1)] + initial_PiJdo0ggGx[100LL * 100LL * (INDEX_pLNuzDlBWy) + 100LL * (INDEX0_CSgvaH5VL6) + (INDEX1_CSgvaH5VL6)] + initial_PiJdo0ggGx[100LL * 100LL * (INDEX_pLNuzDlBWy) + 100LL * (INDEX0_CSgvaH5VL6 - 1) + (INDEX1_CSgvaH5VL6)] + initial_PiJdo0ggGx[100LL * 100LL * (INDEX_pLNuzDlBWy) + 100LL * (INDEX0_CSgvaH5VL6) + (INDEX1_CSgvaH5VL6 - 1)];
			}
		}
	}
}
