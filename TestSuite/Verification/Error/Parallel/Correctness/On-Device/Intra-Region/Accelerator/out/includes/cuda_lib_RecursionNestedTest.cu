...
void cuda_wrapper_increment_5S36YZbPJO(int32_t* initial_EbYenl3BrQ, int32_t* result_gJ1dDQWGX2 ) {
	...
	kernel_cuda_wrapper_increment_5S36YZbPJO<<<1, 168>>> (initial_EbYenl3BrQ, result_gJ1dDQWGX2 );
}
...
void kernel_cuda_wrapper_increment_5S36YZbPJO(int32_t*  initial_EbYenl3BrQ, int32_t* result_gJ1dDQWGX2 ) {
	...
	for ( int range_iterator = 0; range_iterator < exec_range + 0; range_iterator++) {
		int INDEX_5S36YZbPJO = tid * exec_range + range_iterator + 32;
		if (tid < 32) {
			INDEX_5S36YZbPJO -= 32;
		}
		result_gJ1dDQWGX2[(INDEX_5S36YZbPJO)] = counter(initial_EbYenl3BrQ[(INDEX_5S36YZbPJO)]);
	}
}
