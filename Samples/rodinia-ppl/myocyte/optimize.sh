...
mkdir -p $6
java --add-opens java.base/java.lang=ALL-UNNAMED -jar /home/as388453/parallel-pattern-dsl/Samples/rodinia-ppl/PPL_test.jar -n "../../clusters/cluster_c18$1_$2.json" -d 24 -s 24 -i "myocyte.par" -o "$6/$1$2/myocyte_$1_$2.cxx" >> c18$1_$2_$6.txt
