...
mkdir -p $6
java --add-opens java.base/java.lang=ALL-UNNAMED -jar /home/as388453/parallel-pattern-dsl/Samples/rodinia-ppl/PPL_test.jar -n "../../clusters/cluster_c18$1_$2.json" -d 96 -s 96 -i "needle.par" -o "$6/$1$2/needle_$1_$2.cxx" >> c18$1_$2_$6.txt
